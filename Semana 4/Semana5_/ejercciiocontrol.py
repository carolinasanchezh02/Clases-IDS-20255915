...
print(costo)
print("Las cantidades de enero, febrero y marzo son:")
print(f"{Enero}, {Febrero}, {Marzo} con un costo")
print(f"de ${costo:.2f}")"""
...
Lu = int(input("Lunes: "))
Días [0] = Lu
print(Días)   #Para modificar el dato que esta dentro de la lista
